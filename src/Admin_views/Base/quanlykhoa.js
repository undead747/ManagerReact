...
class ThongTinCaNhan extends Component {
  ...
  render() {
    ...
    return (
      ...
      <form class="formcss2">
                ...
                <div class="row">
                   ...
                   <div class="col-md-3">Tên khoa: </div> <input type="text" style={{width:'470px'}} />
                </div> <br/>

                <div class="row">
                     <div class="col-md-1"></div>
                   <div class="col-md-3">Mã khoa: </div> <input type="text" style={{width:'470px'}} />
                 </div> <br/>

                 <div class="row">
                     <div class="col-md-1"></div>
                     <div class="col-md-3">Ngày thành lập:</div>  <input type="date" style={{width:'470px'}} /> -->
                </div> <br/>

                <div class="row">
                     <div class="col-md-1"></div>
                      <div class="col-md-3">Trưởng khoa: </div> <input type="text" style={{width:'470px'}} />
                 </div> <br/>
   ...
   <div class="table-responsive table-condensed">
              <br />
              <h1 style={{"font-weight":"bold"}}>Danh sách Khoa </h1>
              <br />
